...
const GlobalChart = ({ coinsData }) => {
  ...
  //exclusion des stables coins du treemap car ils sont toujours stable
  ...
  return (
    <div className="global-chart">
      <Treemap
        ...
        data={dataArray}
        dataKey="size"
        stroke="rgb(51,51,51)" // couleur des bordures
        fill="black" // couleur des lettres
        aspectRatio="1" // change la forme des boites
      >
