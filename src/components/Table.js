...
const Table = ({ coinsData }) => {
  ...
  const showStable = useSelector((state) => state.stableReducer.showStable); // on récupere des données dans le store
  const showFavList = useSelector((state) => state.listReducer.showList); // on récupere des données dans le store
