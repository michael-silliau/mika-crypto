...
const TableLine = ({ coin, index }) => {
  // affiche le graphique au survole
  ...
  // formatage colonne market cap enleve les 6 derniers chiffres  744 000 000  => 744
  ...
  return (
    <div className="table-line">
      <div className="infos-container">
        ...
        <p>{index + 1}</p>
        <div className="img">
          <img src={coin.image} height="20" alt="icon-img" />
        </div>
        <div className="infos">
          <div
            className="chart-img"
          ...
          <a
            ...
            rel="noreferrer"
          >
            <img src="./assets/info-icon.svg" alt="logo info" />
          </a>
        </div>
      </div>
